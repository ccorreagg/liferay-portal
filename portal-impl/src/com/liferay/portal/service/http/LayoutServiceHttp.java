...
public class LayoutServiceHttp {
	...
	public static com.liferay.portal.kernel.model.Layout
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getLayoutByExternalReferenceCodeParameterTypes20);
	...
	public static com.liferay.portal.kernel.model.Layout
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getLayoutByUuidAndGroupIdParameterTypes21);
	...
	public static String getLayoutName(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getLayoutNameParameterTypes22);
	...
	public static long getLayoutPlid(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getLayoutPlidParameterTypes23);
	...
	public static com.liferay.portal.kernel.model.LayoutReference[]
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getLayoutReferencesParameterTypes24);
	...
	private static final Class<?>[]
		_getLayoutByExternalReferenceCodeParameterTypes20 = new Class[] {
			String.class, long.class
		};
	private static final Class<?>[] _getLayoutByUuidAndGroupIdParameterTypes21 =
		new Class[] {String.class, long.class, boolean.class};
	private static final Class<?>[] _getLayoutNameParameterTypes22 =
		new Class[] {long.class, boolean.class, long.class, String.class};
	private static final Class<?>[] _getLayoutPlidParameterTypes23 =
		new Class[] {String.class, long.class, boolean.class};
	private static final Class<?>[] _getLayoutReferencesParameterTypes24 =
