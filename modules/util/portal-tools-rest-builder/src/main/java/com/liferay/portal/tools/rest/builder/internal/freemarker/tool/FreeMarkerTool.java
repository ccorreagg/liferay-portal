...
public class FreeMarkerTool {
	...
	public boolean isParameterNameScopeRelated(String parameterName) {
		if (isExternalReferenceCodeParameterName(
				parameterName, "AssetLibrary") ||
			isExternalReferenceCodeParameterName(parameterName, "Site") ||
			isIdParameterName(parameterName, "AssetLibrary") ||
			isIdParameterName(parameterName, "Site")) {
