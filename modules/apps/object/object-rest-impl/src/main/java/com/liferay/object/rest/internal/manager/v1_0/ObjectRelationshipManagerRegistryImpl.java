 ...
 */
@Component(service = ObjectRelationshipManagerRegistry.class)
public class ObjectRelationshipManagerRegistryImpl
	implements ObjectRelationshipManagerRegistry {

	@Override
	public ObjectRelationshipManager getObjectRelationshipManager(
	...
	protected void activate(BundleContext bundleContext) {
		_serviceTrackerMap = ServiceTrackerMapFactory.openSingleValueMap(
			bundleContext, ObjectRelationshipManager.class, null,
			(serviceReference, emitter) -> {
				...
				emitter.emit(
					_getKey(
						objectRelationshipManager.getClassName(),
						objectRelationshipManager.getObjectRelationshipType()));
			});
	}
	...
	private ServiceTrackerMap<String, ObjectRelationshipManager>
		_serviceTrackerMap;
