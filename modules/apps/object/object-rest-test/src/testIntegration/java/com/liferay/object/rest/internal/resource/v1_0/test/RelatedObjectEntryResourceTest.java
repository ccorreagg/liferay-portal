...
public class RelatedObjectEntryResourceTest {
	...
	public void setUp() throws Exception {
		...
		_objectRelationship = ObjectTestUtil.addObjectRelationship(
	...
	public void tearDown() throws Exception {
		ObjectTestUtil.deleteObjectRelationship(_objectRelationship);
	...
	public void testPutSystemObjectRelatedObject() throws Exception {
		...
		ObjectEntry objectEntry = ObjectTestUtil.addObjectEntry(
			_objectDefinition,
			Collections.singletonMap(_OBJECT_FIELD_NAME, objectFieldValue));
