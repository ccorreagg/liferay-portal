...
public class ObjectEntryResourceTest {
	...
	@Test
	public void testPostCustomObjectEntryWithRelatedObjectEntry()
		throws Exception {

		// One to many relationship between company scoped and site scoped
		...
		// Relate object entries with external reference code
		...
		// Relate object entries with nested field
		...
		// One to many relationship between site scoped and company scoped
		...
		// One to many relationship between site scoped and site scoped
		...
		jsonObject = jsonObject.getJSONObject(objectRelationship.getName());

		Assert.assertEquals(
			_ERC_VALUE_2, jsonObject.getString("externalReferenceCode"));
		Assert.assertEquals(
