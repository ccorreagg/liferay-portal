...
import com.liferay.object.rest.internal.util.ObjectTestUtil;
...
public class ObjectEntryRelatedObjectsResourceTest {
	...
	public void setUp() throws Exception {
		_objectDefinition = ObjectTestUtil.addObjectDefinition(
			"A" + RandomTestUtil.randomString(),
			Collections.singletonList(
				ObjectTestUtil.addObjectField(
					ObjectFieldConstants.BUSINESS_TYPE_TEXT,
					ObjectFieldConstants.DB_TYPE_STRING, _OBJECT_FIELD_NAME,
					false)),
			true);

		_objectEntry = ObjectTestUtil.addObjectEntry(
			_objectDefinition,
			Collections.singletonMap(_OBJECT_FIELD_NAME, _OBJECT_FIELD_VALUE));
	...
	public void tearDown() throws Exception {
		for (ObjectRelationship objectRelationship : _objectRelationships) {
			ObjectTestUtil.deleteObjectRelationship(objectRelationship);
		}

		ObjectTestUtil.deleteObjectDefinition(_objectDefinition);
		ObjectTestUtil.deleteObjectDefinition(_relatedObjectDefinition);
	}
	...
	public void testGetRelatedCustomObjectsWhenRelationExists()
		...
		_relatedObjectDefinition = ObjectTestUtil.addObjectDefinition(
			"A" + RandomTestUtil.randomString(),
			Collections.singletonList(
				ObjectTestUtil.addObjectField(
					ObjectFieldConstants.BUSINESS_TYPE_TEXT,
		...
		ObjectEntry relatedObjectEntry = ObjectTestUtil.addObjectEntry(
		...
		ObjectRelationship objectRelationship = _addObjectRelationship(
			StringUtil.randomId(), _objectDefinition, _relatedObjectDefinition,
		...
		objectRelationship = _addObjectRelationship(
			StringUtil.randomId(), _relatedObjectDefinition, _objectDefinition,
	...
	private ObjectRelationship _addObjectRelationship(
		...
		ObjectRelationship objectRelationship = _addObjectRelationship(
			name, objectDefinition1, objectDefinition2, type);

		ObjectTestUtil.relateObjectEntries(
	...
	private ObjectRelationship _addObjectRelationship(
		...
		ObjectRelationship objectRelationship =
			ObjectTestUtil.addObjectRelationship(
				name, objectDefinition1, objectDefinition2, type);
