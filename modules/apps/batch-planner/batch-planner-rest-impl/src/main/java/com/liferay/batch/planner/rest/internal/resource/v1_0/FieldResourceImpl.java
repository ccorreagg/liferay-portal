...
public class FieldResourceImpl extends BaseFieldResourceImpl {
	...
	private List<com.liferay.portal.vulcan.batch.engine.Field>
		...
		if (internalClassName.startsWith("com.liferay.object.rest.dto.v1_0.")) {
			String objectDefinitionName = internalClassName.split(
				"com.liferay.object.rest.dto.v1_0.ObjectEntry.")[1];
