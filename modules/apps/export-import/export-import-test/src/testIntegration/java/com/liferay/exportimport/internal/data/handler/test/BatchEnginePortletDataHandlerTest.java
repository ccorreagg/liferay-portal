...
public class BatchEnginePortletDataHandlerTest {
	...
	@Test
	public void testExportImportDepotObjectEntriesToOtherDepot()
		throws Exception {

		_testExportImportDepotObjectEntriesToOtherDepot(
	...
	private void _testExportImportDepotObjectEntriesToOtherDepot(
			int depotEntryType)
		throws Exception {
		...
		DepotEntry depotEntry1 = _addDepotEntry(depotEntryType);

		ObjectEntry[] objectEntries = _addObjectEntries(
			3, depotEntry1.getGroupId(), objectDefinition);

		File larFile = _exportLayouts(
			false, depotEntry1.getGroupId(), false, new long[0],
			objectDefinition);

		DepotEntry depotEntry2 = _addDepotEntry(depotEntryType);

		_importLayouts(
			false, false, larFile, depotEntry2.getGroupId(), objectDefinition);
