...
public class ExportImportTestUtil {
	...
	public static Status importGroupJSONArray(
			long groupId, JSONArray jsonArray, String portletId)
		throws Exception {
		...
		return _importJSONArray(
			group.getCompanyId(), group, jsonArray, portletId);
	}
	...
	public static Status importJSONArray(
		...
		return _importJSONArray(companyId, null, jsonArray, portletId);
	}
	...
	private static Status _importJSONArray(
			long companyId, Group group, JSONArray jsonArray, String portletId)
		throws Exception {
	...
	private static final Snapshot<GroupLocalService>
		_groupLocalServiceSnapshot = new Snapshot<>(
			ExportImportTestUtil.class, GroupLocalService.class);
