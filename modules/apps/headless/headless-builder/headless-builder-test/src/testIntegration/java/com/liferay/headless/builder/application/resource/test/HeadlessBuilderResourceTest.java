...
public class HeadlessBuilderResourceTest extends BaseTestCase {
	...
	public void testGetWithCompanyScopedEndpoint() throws Exception {
		...
		String scopedEndpointPath1 = StringBundler.concat(
		...
		String scopedEndpointPath2 = StringBundler.concat(
		...
		Assert.assertEquals(
			...
			HTTPTestUtil.invokeToHttpCode(
				null,
				String.format(
					scopedEndpointPath1, TestPropsValues.getGroupId()),
				Http.Method.GET));
		Assert.assertEquals(
			200,
			HTTPTestUtil.invokeToHttpCode(
		...
		Assert.assertEquals(
			...
			HTTPTestUtil.invokeToHttpCode(
				null,
				String.format(
					scopedEndpointPath2, TestPropsValues.getGroupId()),
				Http.Method.GET));
