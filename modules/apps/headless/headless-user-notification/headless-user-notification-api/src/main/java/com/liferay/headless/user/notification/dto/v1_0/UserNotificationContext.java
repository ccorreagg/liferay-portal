...
@Generated("")
@GraphQLName(
	description = "Represents the context of a user notification.",
	value = "UserNotificationContext"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "UserNotificationContext")
public class UserNotificationContext implements Serializable {

	public static UserNotificationContext toDTO(String json) {
		return ObjectMapperUtil.readValue(UserNotificationContext.class, json);
	}

	public static UserNotificationContext unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			UserNotificationContext.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.headless.user.notification.dto.v1_0.UserNotificationContext",
		name = "x-class-name"
	)
