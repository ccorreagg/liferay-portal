...
public class Action implements Serializable {
	...
	public static Action toDTO(String json) {
		return ObjectMapperUtil.readValue(Action.class, json);
	}

	public static Action unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Action.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.headless.admin.taxonomy.dto.v1_0.Action",
		name = "x-class-name"
	)
