...
public interface SitePageResource {
	...
	public HttpInvoker.HttpResponse getSitePageHttpResponse(Long id)
		throws Exception;
	...
	public static class SitePageResourceImpl implements SitePageResource {
		...
		public SitePage getSitePage(Long id) throws Exception {
			HttpInvoker.HttpResponse httpResponse = getSitePageHttpResponse(id);
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-delivery/v1.0/site-pages/{id}");
