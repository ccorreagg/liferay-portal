...
public class PageDefinition implements Serializable {
	...
	public void setPageElement(PageElement pageElement) {
		...
		_pageElementSupplier = () -> pageElement;
	}
	...
	private Supplier<PageElement> _pageElementSupplier = () -> null;
	...
	private Supplier<PageRule[]> _pageRulesSupplier = () -> null;
	...
	private Supplier<Double> _versionSupplier = () -> null;
