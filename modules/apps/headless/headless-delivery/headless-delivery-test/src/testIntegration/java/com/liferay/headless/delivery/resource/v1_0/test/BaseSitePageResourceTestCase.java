...
public abstract class BaseSitePageResourceTestCase {
	...
	public void testGetSitePage() throws Exception {
		SitePage postSitePage = testGetSitePage_addSitePage();

		SitePage getSitePage = sitePageResource.getSitePage(
			postSitePage.getId());
	...
	public void testVulcanCRUDItemDelegateGetItem() throws Exception {
		...
		Object item = vulcanCRUDItemDelegate.getItem(postSitePage.getId());

		assertEquals(getSitePage, SitePageSerDes.toDTO(item.toString()));
	}
	...
	protected SitePage testGetSitePage_addSitePage() throws Exception {
		return sitePageResource.postSiteSitePage(
			testGroup.getGroupId(), randomSitePage());
	}

	@Test
	public void testGraphQLGetSitePage() throws Exception {
		SitePage sitePage = testGraphQLGetSitePage_addSitePage();
						...
						invokeGraphQLQuery(
							new GraphQLField(
								...
								new HashMap<String, Object>() {
									{
										put("id", sitePage.getId());
									}
								},
								getGraphQLFields())),
						"JSONObject/data", "Object/page"))));
	...
	@Test
	public void testGraphQLGetSitePageNotFound() throws Exception {
	...
	protected SitePage testGraphQLGetSitePage_addSitePage() throws Exception {
