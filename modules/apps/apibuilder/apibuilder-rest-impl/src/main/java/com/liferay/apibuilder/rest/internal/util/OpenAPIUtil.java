...
public class OpenAPIUtil {
	...
	private static AttributeType _getAttributeType(Schema schema) {
	...
	private static List<Operation> _getOperations(
		Long companyId, PathConfiguration pathConfiguration, PathItem pathItem,
	...
	private static com.liferay.apibuilder.operation.response.ResponseCode
	...
	private static com.liferay.apibuilder.operation.schema.Schema _toSchema(
	...
	private static Map<String, com.liferay.apibuilder.operation.schema.Schema>
	...
	private static void _validate(Map<String, Schema> schemas)
		throws Exception {
	...
	private static void _validate(PathItem pathItem) throws Exception {
		boolean empty = true;
	...
	private static void _validate(Schema schema) throws Exception {
	...
	private static ServiceTrackerMap<String, OperationHandler>
		_operationHandlerServiceTrackerMap;
