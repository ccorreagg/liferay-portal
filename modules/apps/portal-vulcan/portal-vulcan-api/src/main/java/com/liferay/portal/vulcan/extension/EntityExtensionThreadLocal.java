...
public class EntityExtensionThreadLocal {
	...
	public static Map<String, Serializable> getExtendedProperties(Object object) {
		Map<Object, Map<String, Serializable>> objectExtendedProperties = _objectExtendedPropertiesThreadLocal.get();
