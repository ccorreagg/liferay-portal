...
/* tslint:disable */
/* eslint-disable */
export { DigitalSignatureRestClient } from './DigitalSignatureRestClient';
...
export type { DSDocument } from './models/DSDocument';
export type { DSEnvelope } from './models/DSEnvelope';
